...
TOOLS = {
    "obd_code_lookup": obd_code_lookup,
    "safety_check": safety_check,
    "vehicle_system_triage": vehicle_system_triage,
    "maintenance_check": maintenance_check,
    "parts_action_plan": parts_action_plan,
}
...
# Registered separately so this can also be surfaced in future agent traces.
TOOLS["find_nearby_mechanics"] = find_nearby_mechanics
